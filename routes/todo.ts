...
todo.post('/save_todo', todoController.savetodo)
todo.post('/get_todos',  todoController.gettodos)
todo.post('/get_user_todos',  todoController.getusertodos)
todo.post('/send_invite',  todoController.sendInvite)
todo.post('/get_invited_todos',  todoController.getUserInvitedTodos)
todo.get('/confirmation/:token' , todoController.handleConfirmation)
